  ...
  return (
    <div>
      ...
      <div className="help-layout">
        <div className="data-card help-main" style={{ padding: '28px 32px', lineHeight: 1.65, fontSize: 14.5 }}>
          <h2 style={{ fontSize: 16, margin: '0 0 8px' }}>Как читать графики</h2>
          <p>
          ...
          <h2 style={{ fontSize: 16, margin: '20px 0 8px' }}>Загрузка с прибора</h2>
          <p>
          ...
          <h2 style={{ fontSize: 16, margin: '20px 0 8px' }}>Уведомления</h2>
          <p>
          ...
          <h2 style={{ fontSize: 16, margin: '20px 0 8px' }}>Скачать график PDF</h2>
          <p>
        ...
        <aside className="data-card help-aside" style={{ padding: '20px 22px' }}>
          <span className="panel__label">Что-то не работает?</span>
          <p style={{ margin: '10px 0 16px', fontSize: 13.5, color: 'var(--muted)' }}>
