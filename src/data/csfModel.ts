...
const MYOPIA: PatientRecord[] = [
  { code: 'BOP', eye: 'R', pathology: 'myopia', note: '23 года, выс. степ. + ПВХРД', phase1: -0.44, slopePFC: 0.18, nfHf: 6.9, nf: 15.4, vf: 2.2 },
  { code: 'BOP', eye: 'L', pathology: 'myopia', note: 'выс. степ. + ПВХРД', phase1: -1.20, slopePFC: 0.13, nfHf: 6.8, nf: 12.6, vf: 1.8 },
  { code: 'GGG', eye: 'R', pathology: 'myopia', note: '61 год', phase1: -1.61, slopePFC: 0.11, nfHf: 5.3, nf: 23.6, vf: 4.5 },
  ...
  { code: 'NIN', eye: 'R', pathology: 'myopia', note: '25 лет', phase1: -1.59, slopePFC: 0.12, nfHf: 11.4, nf: 36.3, vf: 3.2 },
  ...
  { code: 'SEA', eye: 'R', pathology: 'myopia', note: '36 лет', phase1: -1.76, slopePFC: 0.10, nfHf: 10.5, nf: 21.3, vf: 2.0 },
  { code: 'SEA', eye: 'L', pathology: 'myopia', phase1: -1.77, slopePFC: 0.10, nfHf: 8.9, nf: 18.1, vf: 2.0 },
  { code: 'SYV', eye: 'R', pathology: 'myopia', note: '61 год', phase1: -2.04, slopePFC: 0.14, nfHf: 7.2, nf: 17.6, vf: 2.4 },
  ...
  { code: 'TAG', eye: 'L', pathology: 'myopia', phase1: -1.26, slopePFC: 0.18, nfHf: 3.6, nf: 34.0, vf: 9.3 },
]
...
const GLAUCOMA: PatientRecord[] = [
  ...
  { code: 'IAN', eye: 'L', pathology: 'glaucoma', phase1: 0.36, slopePFC: 0.28, nfHf: 2.2, nf: 15.8, vf: 7.0 },
  ...
  { code: 'ITP', eye: 'R', pathology: 'glaucoma', note: '69 лет', phase1: -1.43, slopePFC: 0.15, nfHf: 5.6, nf: 19.5, vf: 3.3 },
  ...
  { code: 'SLI', eye: 'L', pathology: 'glaucoma', phase1: -0.08, slopePFC: 0.22, nfHf: 4.1, nf: 24.7, vf: 6.1 },
  ...
  { code: 'SYN', eye: 'R', pathology: 'glaucoma', note: '77 лет', phase1: -0.52, slopePFC: 0.22, nfHf: 4.2, nf: 10.0, vf: 2.7 },
...
const AMD: PatientRecord[] = [
  ...
  { code: 'BEN', eye: 'L', pathology: 'amd', phase1: -1.3, slopePFC: 0.27, nfHf: 1.51, nf: 1.27, vf: 0.8 },
  { code: 'ENF', eye: 'R', pathology: 'amd', note: '73 года', phase1: -1.6, slopePFC: 0.14, nfHf: 4.4, nf: 27.1, vf: 6.2 },
  { code: 'ENF', eye: 'L', pathology: 'amd', phase1: -1.7, slopePFC: 0.14, nfHf: 4.0, nf: 23.5, vf: 5.8 },
  { code: 'GLG', eye: 'R', pathology: 'amd', note: '67 лет', phase1: -1.9, slopePFC: 0.14, nfHf: 5.9, nf: 15.6, vf: 2.7 },
  ...
  { code: 'KN', eye: 'L', pathology: 'amd', phase1: 0.05, slopePFC: 0.25, nfHf: 2.6, nf: 11.9, vf: 4.7 },
  { code: 'LAV', eye: 'R', pathology: 'amd', phase1: -1.2, slopePFC: 0.15, nfHf: 6.0, nf: 41.9, vf: 7.0 },
  { code: 'LAV', eye: 'L', pathology: 'amd', phase1: -1.0, slopePFC: 0.17, nfHf: 5.7, nf: 32.7, vf: 5.8 },
  { code: 'NEI', eye: 'R', pathology: 'amd', note: '73 года', phase1: -1.9, slopePFC: 0.14, nfHf: 7.6, nf: 19.3, vf: 2.5 },
  { code: 'NEI', eye: 'L', pathology: 'amd', phase1: -1.8, slopePFC: 0.13, nfHf: 5.1, nf: 14.1, vf: 2.8 },
  { code: 'NSA', eye: 'R', pathology: 'amd', note: '74 года', phase1: -2.0, slopePFC: 0.13, nfHf: 5.5, nf: 6.7, vf: 1.2 },
  { code: 'NSA', eye: 'L', pathology: 'amd', phase1: -1.8, slopePFC: 0.13, nfHf: 3.8, nf: 8.2, vf: 2.1 },
